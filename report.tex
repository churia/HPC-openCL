...
\centering
\subfigure[original photo]{\includegraphics[width=0.45\linewidth]{fig/whale.png}}
\subfigure[blurred 100 times]{\includegraphics[width=0.45\linewidth]{fig/whale1.png}}
...
\centering
\subfigure[original photo]{\includegraphics[width=0.45\linewidth]{fig/whale.png}}
\subfigure[blurred 100 times]{\includegraphics[width=0.45\linewidth]{fig/whale2.png}}
\subfigure[blurred 1000 times]{\includegraphics[width=0.45\linewidth]{fig/whale3.png}}
\subfigure[blurred 10000 times]{\includegraphics[width=0.45\linewidth]{fig/whale4.png}}
